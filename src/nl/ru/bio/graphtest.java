...
public final class graphtest
{
    ...
    private static SimpleWeightedGraph<Long, DefaultWeightedEdge> createWeightedGraph()
    {
    	SimpleWeightedGraph<Long, DefaultWeightedEdge> g = new SimpleWeightedGraph<Long, DefaultWeightedEdge>(DefaultWeightedEdge.class);
       ...
       g.setEdgeWeight(e1, 4l);
       g.setEdgeWeight(e2, 5l);
       g.setEdgeWeight(e3, 6l);
       g.setEdgeWeight(e4, 7l);
    ...
    public static void main(String [] args)
    {
        ...
        SimpleWeightedGraph<Long, DefaultWeightedEdge> stringGraphv2 = createWeightedGraph();

        // note undirected edges are printed as: {<v1>,<v2>}
        System.out.println(stringGraph.toString());
        System.out.println(stringGraphv2.toString());
